...
$sqltime1 = "SELECT nome FROM tab1times WHERE idjogo = 1";
...
#FOTO TIME
$sqlfoto1 = "SELECT foto FROM tab1times WHERE idjogo = 1";
...
$sqltime2 = "SELECT nome FROM tab1times WHERE idjogo = 2";
...
#FOTO TIME
$sqlfoto2 = "SELECT foto FROM tab1times WHERE idjogo = 2";
...
$sqltime3 = "SELECT nome FROM tab1times WHERE idjogo = 3";
...
#FOTO TIME
$sqlfoto3 = "SELECT foto FROM tab1times WHERE idjogo = 3";
...
$sqltime4 = "SELECT nome FROM tab1times WHERE idjogo = 4";
...
#FOTO TIME
$sqlfoto4 = "SELECT foto FROM tab1times WHERE idjogo = 4";
...
$sqltime5 = "SELECT nome FROM tab1times WHERE idjogo = 5";
...
#FOTO TIME
$sqlfoto5 = "SELECT foto FROM tab1times WHERE idjogo = 5";
...
$sqltime6 = "SELECT nome FROM tab1times WHERE idjogo = 6";
...
#FOTO TIME
$sqlfoto6 = "SELECT foto FROM tab1times WHERE idjogo = 6";
...
$sqltime7 = "SELECT nome FROM tab1times WHERE idjogo = 7";
...
#FOTO TIME
$sqlfoto7 = "SELECT foto FROM tab1times WHERE idjogo = 7";
...
$sqltime8 = "SELECT nome FROM tab1times WHERE idjogo = 8";
...
#FOTO TIME
$sqlfoto8 = "SELECT foto FROM tab1times WHERE idjogo = 8";
...
$sqltime9 = "SELECT nome FROM tab1times WHERE idjogo = 9";
...
#FOTO TIME
$sqlfoto9 = "SELECT foto FROM tab1times WHERE idjogo = 9";
...
$sqltime10 = "SELECT nome FROM tab1times WHERE idjogo = 10";
...
#FOTO TIME
$sqlfoto10 = "SELECT foto FROM tab1times WHERE idjogo = 10";
...
$sqltime11 = "SELECT nome FROM tab1times WHERE idjogo = 11";
...
#FOTO TIME
$sqlfoto11 = "SELECT foto FROM tab1times WHERE idjogo = 11";
...
$sqltime12 = "SELECT nome FROM tab1times WHERE idjogo = 12";
...
#FOTO TIME
$sqlfoto12 = "SELECT foto FROM tab1times WHERE idjogo = 12";
...
$sqltime13 = "SELECT nome FROM tab1times WHERE idjogo = 13";
...
#FOTO TIME
$sqlfoto13 = "SELECT foto FROM tab1times WHERE idjogo = 13";
...
$sqltime14 = "SELECT nome FROM tab1times WHERE idjogo = 14";
...
#FOTO TIME
$sqlfoto14 = "SELECT foto FROM tab1times WHERE idjogo = 14";
...
$sqltime15 = "SELECT nome FROM tab1times WHERE idjogo = 15";
...
#FOTO TIME
$sqlfoto15 = "SELECT foto FROM tab1times WHERE idjogo = 15";
...
$sqltime16 = "SELECT nome FROM tab1times WHERE idjogo = 16";
...
#FOTO TIME
$sqlfoto16 = "SELECT foto FROM tab1times WHERE idjogo = 16";
...
$sqltime17 = "SELECT nome FROM tab1times WHERE idjogo = 17";
...
#FOTO TIME
$sqlfoto17 = "SELECT foto FROM tab1times WHERE idjogo = 17";
...
$sqltime18 = "SELECT nome FROM tab1times WHERE idjogo = 18";
...
#FOTO TIME
$sqlfoto18 = "SELECT foto FROM tab1times WHERE idjogo = 18";
...
$sqltime19 = "SELECT nome FROM tab1times WHERE idjogo = 19";
...
#FOTO TIME
$sqlfoto19 = "SELECT foto FROM tab1times WHERE idjogo = 19";
...
$sqltime20 = "SELECT nome FROM tab1times WHERE idjogo = 20";
...
#FOTO TIME
$sqlfoto20 = "SELECT foto FROM tab1times WHERE idjogo = 20";
...
<div class="container-fluid center mt-3">
	<div class="row">
		...
		<form method="GET" action="principal2.php">
			<table align="center">
					<tr>
						<td> <input style="width: 25px; height: 20px" name="resultado1" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado2" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado3" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado4" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado5" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado6" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado7" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado8" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado9" type="text"></td>
...
<tr>
				...
				<tr>
					<td><input style="width: 25px; height: 20px" name="resultado10" type="text"></td>
